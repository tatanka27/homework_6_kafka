package com.example.one.service.messaging.service;

import com.example.one.service.OrderService;
import com.example.one.service.dto.OrderDto;
import com.example.one.service.messaging.event.OrderEvent;
...
public class KafkaMessagingService {
    ...
    @Transactional
    @KafkaListener(topics = topicCreateOrder, groupId = kafkaConsumerGroupId, properties = {"spring.json.value.default.type=com.example.one.service.messaging.event.OrderEvent"})
